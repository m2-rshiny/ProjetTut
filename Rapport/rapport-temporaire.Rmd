...
(center scale one hot encoding model matrix etc)

### 3.1.2 Imputation des données manquantes

(celles proposées par mice)

## 3.2 Echantillonnage

### 3.2.1 Découpage des données

Présentation de l'intérrêt de découpées les données en train/test et échantillon de validation
...
### 4.4.1 Préparation de donnees (Lucas)
...
### 4.4.2 Statistiques Descriptives (Mamadou)
...
- pour certains des algorithmes, comme *preProcessing*, les donnees sont centrees et reduites par defaut
...
### 4.4.4 ML Algorithme (Mamadou/Lucas)
...
# 5. Structure de l'application (Soheil)
