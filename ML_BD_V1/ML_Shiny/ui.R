...
# Imputation
ui_imput <- uiOutput("imputation")
plot_density_imput <- plotOutput("show_imput")

method_imputation <- selectInput("met_imput", "Imputation methode", choices = c("pmm", "norm", "mean"))
...
#Barre de lien pour exporter une configuration
dl_cofig <- downloadLink("downloadConfig", "Download this configuration")
